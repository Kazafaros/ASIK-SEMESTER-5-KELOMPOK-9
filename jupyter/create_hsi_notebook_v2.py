...
# Create HSI calculation notebook - V2 (Fixed)
notebook = {
    "cells": [
        {
            "cell_type": "markdown",
...
print("✅ HSI calculation notebook V2 created successfully!")
print("\nImprovements:")
print("  - Fixed vectorized functions (flatten/reshape approach)")
print("  - Added error handling in visualization cell")
print("  - Added error handling in save cell")
print("  - Better progress messages")
print("  - More robust code structure")
