"""
Fix untuk fungsi vectorized HSI calculation
Masalah: masking tidak compatible dengan shape array
"""

fixed_code = """
# Vectorized versions untuk array operations (lebih cepat) - FIXED
...
with open('fixed_vectorized_functions.txt', 'w', encoding='utf-8') as f:
    f.write(fixed_code)

print("Fixed code saved to fixed_vectorized_functions.txt")
print("\nCara menggunakan:")
print("1. Copy kode dari fixed_vectorized_functions.txt")
print("2. Replace Cell 4 di notebook dengan kode yang sudah diperbaiki")
